...
public class SlowingStance extends Skill {
	
	public static String skillName = "Slowing Stance";
	...
	public static ItemStack getItem(Player player) {
		...
		loreList.add("§aEffect §7: User takes a slowing");
		loreList.add("§7stance which cause his next attack");
		loreList.add("§7to slow the target by one stage.");
	...
	public SlowingStance(LivingEntity source, ArrayList<LivingEntity> targets) {
	...
	public void onEffect() {
		...
		container.set(key, PersistentDataType.STRING, "Slow");
	}
