...
public class Abnegation extends Skill {
	
	public static String skillName = "Abnegation";
	public static Material skillMaterial = Material.COD_SPAWN_EGG;
	public static int skillDelayTicks = 0;
	public static int skillCastDuration = 10;
	public static int skillCooldown = 20*30;
	...
	public static ItemStack getItem(Player player) {
		...
		loreList.add("§aEffect §7: Increase the user's physical");
		loreList.add("§7damage resistance by two stages.");
	...
	public Abnegation(LivingEntity source, ArrayList<LivingEntity> targets) {
	...
	public void onEffect() {
		...
		UtilFuncs.buffEntity(source, PotionEffectType.DAMAGE_RESISTANCE, 2, (int) (skillEffectDuration*RoCPlayers.getEffectDurationAugmentation(((Player) source))));
	}
