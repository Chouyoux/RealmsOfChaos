...
public class FireTouch extends Skill {
	
	public static String skillName = "Fire Touch";
	...
	public static ItemStack getItem(Player player) {
		...
		loreList.add("§7to set the target on fire.");
	...
	public FireTouch(LivingEntity source, ArrayList<LivingEntity> targets) {
