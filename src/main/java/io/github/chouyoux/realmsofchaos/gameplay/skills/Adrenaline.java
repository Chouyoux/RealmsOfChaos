...
public class Adrenaline extends Skill {
	...
	public static String skillName = "Adrenaline";
	public static Material skillMaterial = Material.SHEEP_SPAWN_EGG;
	...
	public static ItemStack getItem(Player player) {
		...
		loreList.add("§aEffect §7: Increase the user's movement");
		loreList.add("§7speed by two stages.");
	...
	public Adrenaline(LivingEntity source, ArrayList<LivingEntity> targets) {
	...
	public void onEffect() {
		...
		UtilFuncs.buffEntity(source, PotionEffectType.SPEED, 2, (int) (skillEffectDuration*RoCPlayers.getEffectDurationAugmentation(((Player) source))));
	}
