...
public class DemonStance extends Skill {
	
	public static String skillName = "Demon Stance";
	...
	public static ItemStack getItem(Player player) {
		...
		loreList.add("§aEffect §7: User takes a demon");
		loreList.add("§7stance which cause his next attack");
		loreList.add("§7to heal him for half the damages.");
	...
	public DemonStance(LivingEntity source, ArrayList<LivingEntity> targets) {
	...
	public void onEffect() {
		...
		container.set(key, PersistentDataType.STRING, "Lifesteal");
	}
