...
public class ParalysingPoison extends Skill {
	
	public static String skillName = "Paralysing Poison";
	...
	public static ItemStack getItem(Player player) {
		...
		loreList.add("§aEffect §7: Applies paralysing poison");
		loreList.add("§7on your next projectile which will");
		loreList.add("§7affect its target.");
	...
	public ParalysingPoison(LivingEntity source, ArrayList<LivingEntity> targets) {
