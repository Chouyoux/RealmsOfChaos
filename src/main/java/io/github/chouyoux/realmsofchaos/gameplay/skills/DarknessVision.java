...
public class DarknessVision extends Skill {
	
	public static String skillName = "Darkness Vision";
	public static Material skillMaterial = Material.BAT_SPAWN_EGG;
	...
	public static ItemStack getItem(Player player) {
		...
		loreList.add("§aEffect §7: The user gives the target");
		loreList.add("§7a vision of Darkness.");
	...
	public DarknessVision(LivingEntity source, ArrayList<LivingEntity> targets) {
