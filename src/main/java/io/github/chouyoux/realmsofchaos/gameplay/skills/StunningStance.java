...
public class StunningStance extends Skill {
	
	public static String skillName = "Stunning Stance";
	...
	public static ItemStack getItem(Player player) {
		...
		loreList.add("§aEffect §7: User takes a stunning");
		loreList.add("§7stance which cause his next attack");
		loreList.add("§7to cause nausea to the target.");
	...
	public StunningStance(LivingEntity source, ArrayList<LivingEntity> targets) {
	...
	public void onEffect() {
		...
		NamespacedKey key = new NamespacedKey(RealmsOfChaos.getInstance(), "NextHitEffect");
		PersistentDataContainer container = source.getPersistentDataContainer();
		container.set(key, PersistentDataType.STRING, "Nausea");
	}
