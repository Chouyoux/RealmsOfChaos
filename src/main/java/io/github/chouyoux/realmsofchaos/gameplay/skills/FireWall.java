...
public class FireWall extends Skill {
	
	public static String skillName = "Fire Wall";
	...
	public static ItemStack getItem(Player player) {
		...
		loreList.add("§aEffect §7: User summons a fire wall");
		loreList.add("§7that sets ally projectiles crossing it");
	...
	public FireWall(LivingEntity source, ArrayList<LivingEntity> targets) {
	...
	public void onEffect() {
		...
		Particles.DirectionalWall(target_loc, Particle.FLAME, x, (int) skillRadius, skillEffectDuration);
