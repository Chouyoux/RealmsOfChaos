...
public class Knockback extends Skill {
	...
	public static String skillName = "Knockback";
	public static Material skillMaterial = Material.CAT_SPAWN_EGG;
	...
	public static ItemStack getItem(Player player) {
		...
		loreList.add("§aEffect §7: User will shoot its next");
		loreList.add("§7projectile so that it knocks back");
		loreList.add("§7its target further than usual.");
	...
	public Knockback(LivingEntity source, ArrayList<LivingEntity> targets) {
	...
	public void onEffect() {
		...
		container.set(key, PersistentDataType.STRING, "KB");
	}
