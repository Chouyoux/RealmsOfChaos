...
import io.github.chouyoux.realmsofchaos.particle_effects.CleanseEffect;
import io.github.chouyoux.realmsofchaos.util.UtilFuncs;

public class MindCleanse extends Skill {
	
	public static String skillName = "Mind Cleanse";
	public static Material skillMaterial =  Material.STRAY_SPAWN_EGG;
	...
	public static ItemStack getItem(Player player) {
		...
		loreList.add("§aEffect §7: The user gets rid of all");
		loreList.add("§7negatives effects applied on him.");
	...
	public MindCleanse(LivingEntity source, ArrayList<LivingEntity> targets) {
	...
	public void onEffect() {
		UtilFuncs.removeAllNegativePotions(source);
		if (source instanceof HumanEntity) ((HumanEntity) source).setCooldown(Material.SHIELD, 0);
		new CleanseEffect(RealmsOfChaos.effectManager, source);
	}
