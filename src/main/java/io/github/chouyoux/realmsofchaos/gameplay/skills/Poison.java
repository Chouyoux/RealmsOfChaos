...
public class Poison extends Skill {
	...
	public static String skillName = "Poison";
	public static Material skillMaterial = Material.PIGLIN_SPAWN_EGG;
	...
	public static ItemStack getItem(Player player) {
		...
		loreList.add("§aEffect §7: Applies poison on your");
		loreList.add("§7next projectile which will affect");
	...
	public Poison(LivingEntity source, ArrayList<LivingEntity> targets) {
	...
	public void onEffect() {
		...
		container.set(key, PersistentDataType.STRING, "Poison");
	}
