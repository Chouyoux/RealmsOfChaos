...
public class EntraveToEvil extends Skill {
	
	public static String skillName = "Entrave to Evil";
	public static Material skillMaterial = Material.SKELETON_SPAWN_EGG;
	...
	public static ItemStack getItem(Player player) {
		...
		loreList.add("§aEffect §7:");
		loreList.add("§7The user entraves the target's movements.");
	...
	public EntraveToEvil(LivingEntity source, ArrayList<LivingEntity> targets) {
	...
	public void onEffect() {
		...
		targets.get(0).addPotionEffect(new PotionEffect(PotionEffectType.SLOW, duration, 99));
	}
