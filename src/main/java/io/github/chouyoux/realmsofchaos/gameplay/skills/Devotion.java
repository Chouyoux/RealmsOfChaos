...
public class Devotion extends Skill {
	
	public static String skillName = "Devotion";
	...
	public static ItemStack getItem(Player player) {
		...
		loreList.add("§7attack damages by one stage.");
	...
	public Devotion(LivingEntity source, ArrayList<LivingEntity> targets) {
	...
	public void onEffect() {
		...
		UtilFuncs.buffEntity(source, PotionEffectType.INCREASE_DAMAGE, 1, (int) (skillEffectDuration*RoCPlayers.getEffectDurationAugmentation(((Player) source))));
	}
